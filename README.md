...
-   Use o comando: `git clone git@github.com:tryber/python-030-python-projeto-inventory-report.git`
-   Entre na pasta do repositório que você acabou de clonar:
    -   `cd python-030-python-projeto-inventory-report`
...
-   No menu à direita, clique no _link_ **'Reviewers'** e digite `students`, selecione o time `tryber/students-sd-030-python`.
...
[Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH30-PYTHON&template=betrybe/python-0x-projeto-inventory-report)
